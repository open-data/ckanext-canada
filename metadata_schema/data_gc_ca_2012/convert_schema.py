...
FIELD_MAPPING = {
    ...
    'supplemantary_documentation_en': 'supplemental_information_other',
...
BILINGUAL_FIELDS = {
    ...
    'supplemantary_documentation_fr': 'supplemental_information_other',
