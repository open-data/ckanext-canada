...
class CanadaDatasetsPlugin(SchemingDatasetsPlugin):
    ...
    def before_dataset_search(self, search_params):
        ...
        search_params['facet.range.start'] = 'NOW/DAY-%sYEARS' % RELEASE_DATE_FACET_STEP
        search_params['facet.range.end'] = 'NOW/DAY+%sYEARS' % RELEASE_DATE_FACET_STEP
        search_params['facet.range.gap'] = '+%sYEARS' % RELEASE_DATE_FACET_STEP
