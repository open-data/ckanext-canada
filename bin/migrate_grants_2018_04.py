...
for line in in_csv:
    ...
    line['recipient_legal_name'] = en_slash_fr(
        line.pop('recipient_name_en'),
        line.pop('recipient_name_fr'))
    line['recipient_city_en'] = en_slash_fr(
