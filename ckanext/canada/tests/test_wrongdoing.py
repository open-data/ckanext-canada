...
class TestWrongdoing(CanadaTestBase):
    ...
    def setup_class(self):
        ...
        """
        super(TestWrongdoing, self).setup_class()
    ...
    def test_example(self):
        ...
        """
        record = get_chromo('wrongdoing')['examples']['record'].copy()
    ...
    def test_required_fields(self):
        ...
        """
        chromo = get_chromo('wrongdoing')
        record = chromo['examples']['record'].copy()

        # FIXME: file_id_date does not have required trigger
        # FIXME:  findings_conclusions does not have required trigger
        skips = ['file_id_date', 'findings_conclusions',]

        expected_required_fields = ['file_id_number', 'case_description_en',
                                    'case_description_fr', 'recommendations_corrective_measures_en',
    ...
    def test_choice_fields(self):
        ...
        expected_choice_fields = ['findings_conclusions',]
