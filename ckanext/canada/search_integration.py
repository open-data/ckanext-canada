...
def add_to_search_index(data_dict):
    ...
    try:
        ...
        org_title_at_publication = json.loads(data_dict['org_title_at_publication'])
        owner_org_title_en = org_title_at_publication['en']
        owner_org_title_fr = org_title_at_publication['fr']

        subjects_en = []
        subjects_fr = []
        subjects = json.loads(data_dict['subject'])
        for s in subjects:
        ...
        for r in data_dict['resources']:
            ...
            resource_name = json.loads(r['name_translated'])
        ...
        notes_translated = json.loads(data_dict['notes_translated'])
        title_translated = json.loads(data_dict['title_translated'])
        od_obj = {
            ...
            'title_en_s': str(title_translated['en']).strip() if 'en' in title_translated else '',
            'title_fr_s': str(title_translated['fr']).strip() if 'fr' in title_translated else '',
        ...
        keywords = json.loads(data_dict['keywords'])
        if 'en' in keywords:
